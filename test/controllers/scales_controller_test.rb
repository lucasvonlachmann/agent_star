...
class ScalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scale" do
    assert_difference('Scale.count') do
      post scales_url, params: { scale: { carrier_id: @scale.carrier_id, service: @scale.service, vessel_id: @scale.vessel_id, voyage: @scale.voyage } }
    end
  ...
  test "should update scale" do
    patch scale_url(@scale), params: { scale: { carrier_id: @scale.carrier_id, service: @scale.service, vessel_id: @scale.vessel_id, voyage: @scale.voyage } }
